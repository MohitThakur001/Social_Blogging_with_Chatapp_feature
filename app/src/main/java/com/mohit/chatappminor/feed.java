            ...
            protected void populateViewHolder(BlogzoneViewHolder viewHolder, Blogzone model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent singleActivity = new Intent(feed.this, SinglePostActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int id = item.getItemId();
         if (id == R.id.action_add) {
            startActivity(new Intent(feed.this, post.class));
            feed.this.finish();
        } else if (id == R.id.logout){
            mAuth.signOut();
            Intent logouIntent = new Intent(feed.this, LoginActivity.class);
